...
namespace HGE.IO.AudioEngine.sidPlayLib.components.mos6510
{
    internal class MOS6510
    {
        ...
        public MOS6510(EventScheduler context, sidPlayer owner)
        {
        ...
        public MOS6510(EventScheduler context, sidPlayer owner, BinaryReader reader, EventList events)
        {
            eventContext = context;
            player = owner;
